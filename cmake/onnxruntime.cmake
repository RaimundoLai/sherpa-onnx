...
if(location_onnxruntime_header_dir AND location_onnxruntime_lib)
  if(NOT DEFINED onnxruntime_lib_files)
    ...
    elseif(APPLE)
      # Use specific pattern to avoid matching .dSYM directories
      file(GLOB onnxruntime_lib_files "$ENV{SHERPA_ONNXRUNTIME_LIB_DIR}/libonnxruntime*dylib")
    else()
    ...
    # Filter out directories (e.g., .dSYM on macOS) from the file list
    set(onnxruntime_lib_files_filtered)
    foreach(f ${onnxruntime_lib_files})
      if(NOT IS_DIRECTORY ${f})
        list(APPEND onnxruntime_lib_files_filtered ${f})
      endif()
    endforeach()
    set(onnxruntime_lib_files ${onnxruntime_lib_files_filtered})
    message(STATUS "onnxruntime lib files (filtered): ${onnxruntime_lib_files}")
