...
typedef struct SherpaOnnxOfflineTtsChatterboxModelConfig {
...
typedef struct SherpaOnnxOfflineTtsMiocodecLlamaModelConfig {
...
SHERPA_ONNX_API const SherpaOnnxGeneratedAudio *
SherpaOnnxOfflineTtsGenerateWithChatterbox(const SherpaOnnxOfflineTts *tts,
                                         const char *text,
...
typedef struct SherpaOnnxOfflineTtsMiocodecLlamaEmbeddings {
