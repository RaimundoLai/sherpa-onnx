...
module.exports = {
  ...
  readWaveAsync : addon.readWaveAsync,
  ...
  createTalkingVideoPipelineAsync : talking_video.createTalkingVideoPipelineAsync,
  renderIdleLoop : talking_video.renderIdleLoop,
